...
- An API key or subscription from at least one LLM provider (Anthropic, OpenAI, etc.) — or use [offline mode](/experimental/offline) with no API key
...
<CardGroup cols={2}>
  <Card title="TUI Cookbook" icon="book-marked" href="/cookbook/login">
    Visual guides for every TUI workflow — login, models, files, approvals, and more.
  </Card>
