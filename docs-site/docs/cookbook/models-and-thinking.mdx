...
:::tip
You can also set your default model and provider via CLI flags: `ante --provider openai --model gpt-5.5`, or configure defaults in your [preferences](/configuration/preference).
:::
